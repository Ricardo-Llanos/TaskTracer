<?php
//En los condicionales, si la sentencia es de solo 1 línea, los "{}" son opcinales

if (!defined('ROOT_PATH')) define('ROOT_PATH', __DIR__.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR);
